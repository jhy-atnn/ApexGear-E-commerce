...
<body>
    <?php $currentAdminPage = 'manage_deals.php';
                                                ...
                                                <div class="deal-body">
                                                    ...
                                                    <div class="deal-detail timer-display" data-expiry="<?php echo strtotime($p['valid_until']); ?>">
                                                        <div class="timer-block">
                                                            <div class="timer-val" data-part="d">00</div>
                                                            <div class="timer-lbl">Days</div>
                                                        </div>
                                                        <div class="timer-block">
                                                            <div class="timer-val" data-part="h">00</div>
                                                            <div class="timer-lbl">Hrs</div>
                                                        </div>
                                                        <div class="timer-block">
                                                            <div class="timer-val" data-part="m">00</div>
                                                            <div class="timer-lbl">Mins</div>
                                                        </div>
                                                        <div class="timer-block">
                                                            <div class="timer-val" data-part="s">00</div>
