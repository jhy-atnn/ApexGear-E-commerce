...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Tabs */
        .arc-tabs { display: flex; gap: 8px; margin-bottom: 24px; }
        .arc-tab {
            padding: 9px 22px; border-radius: 9px; font-weight: 700;
            font-size: .84rem; cursor: pointer; border: 2px solid var(--border);
            background: var(--card-bg); color: var(--text-muted); transition: all .18s;
        }
        .arc-tab.active { background: var(--blue); color: #fff; border-color: var(--blue); }
        .arc-tab:hover:not(.active) { border-color: var(--blue); color: var(--blue); }
        ...
        .tbl td { padding: 14px 16px; font-size: .86rem; vertical-align: middle; }

        .product-thumb { width: 42px; height: 42px; border-radius: 8px; background: var(--panel-bg); object-fit: cover; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; }
        .product-thumb img { width: 100%; height: 100%; object-fit: cover; }
        .product-thumb svg { width: 32px; height: 32px; }
        .product-name { font-weight: 600; font-size: .88rem; }
        .product-meta { font-size: .75rem; color: var(--text-muted); margin-top: 2px; }

        .act-btn { border: none; border-radius: 7px; padding: 6px 14px; font-size: .78rem; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; transition: opacity .15s; }
        .btn-restore { background: rgba(0,214,143,.12); color: #009c60; }
        .btn-restore:hover { opacity: .8; }
        .btn-delete  { background: rgba(255,59,92,.1); color: var(--danger); }
        .btn-delete:hover { opacity: .8; }

        .status-pill { display: inline-flex; align-items: center; gap: 5px; padding: 4px 10px; border-radius: 20px; font-size: .72rem; font-weight: 700; }
        .status-delivered { background: rgba(0,214,143,.12); color: #009c60; }
        ...
        .apex-alert.danger  { background: rgba(255,59,92,.1); color: var(--danger); border: 1px solid rgba(255,59,92,.25); }
        .apex-alert .close-btn { margin-left: auto; background: none; border: none; cursor: pointer; font-size: 1rem; color: inherit; opacity: .6; }
    </style>
</head>
<body>
